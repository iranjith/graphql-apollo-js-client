...
import bitmap_image from "../../assets/images/Bitmap.png";
import bitmap1_image from "../../assets/images/Bitmap(1).png";
import shutterstock_image from "../../assets/images/shutterstock_211091626.png";
        ...
        <div className="container">
          <div className="row">
            <div className="col-xs-12 col-sm-4 col-md-4 adj_text">
              ...
              <img src={bitmap_image} alt="Public Adjuster" />
            ...
            <div className="col-xs-12 col-sm-4 col-md-4 adj_text">
              ...
              <img src={bitmap1_image} alt="Public" />
              <div className="read-more-btn">
            ...
            <div className="col-xs-12 col-sm-4 col-md-4 adj_text">
              ...
              <img src={shutterstock_image} alt="Public" />
              <div className="read-more-btn">
                <Link to="/" className="btn-oval">
                  Learn More
                </Link>
