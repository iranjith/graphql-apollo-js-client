...
import shutterstock_252243790 from "../../assets/images/shutterstock_252243790.png";
import shutterstock_564197512 from "../../assets/images/shutterstock_564197512.png";
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-xs-12 col-sm-4 col-md-4 adj_text">
              <img src={shutterstock_252243790} alt="Public" />
      ...
      <section className="sec_include1">
        <div className="container">
          <div className="row">
            ...
            <div className="col-xs-12 col-sm-4 col-md-4 adj_text">
              <img src={shutterstock_564197512} alt="Public" />
              <div className="readtext">
